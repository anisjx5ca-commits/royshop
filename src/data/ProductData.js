...
export const products = [
  ...
  },
  {
    ...
    sizes: ['XS', 'S', 'M', 'L', 'XL', 'XXL'],
    description: 'Elegant and cozy cable knit sweater perfect for any season. Premium quality with comfortable fit. Ideal for casual or semi-formal occasions.',
    material: '80% Wool, 20% Acrylic',
    care: 'Hand wash in cool water. Lay flat to dry. Do not bleach.',
    rating: 0,
    reviewCount: 0,
    inStock: true,
    tags: ['sweater', 'wool', 'elegant', 'casual'],
  },
  {
    id: 8,
